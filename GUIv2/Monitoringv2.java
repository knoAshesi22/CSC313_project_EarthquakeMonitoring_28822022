...
//    private ArrayList<Observatory> observatories;
    private HashSet<Observatory> observatories;
    ...
    public HashSet<Observatory> getObservatories(){
...
//                    ");";
    ...
    public void insertGalamsey(Galamsey g, String oname){
        insertGalamsey(g.getVegColour(),g.getPosition().getLatitude(),g.getPosition().getLongitude(),g.getYear().toString(), oname);
    }
